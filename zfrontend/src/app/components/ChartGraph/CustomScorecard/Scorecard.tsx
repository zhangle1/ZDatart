...
class Scorecard extends ReactChart {
  ...
  constructor(props?) {
    super(ScorecardAdapter, {
      id: props?.id || 'custom-react-scorecard',
      name: props?.name || 'viz.palette.graph.names.customerScoreChart',
  ...
  getOptions(
   ...
   const suffixConfig= this.getSuffixConfig(styleConfigs,
    fontSizeFn,)
